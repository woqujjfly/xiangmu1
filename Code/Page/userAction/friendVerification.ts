...
import { VueVerify } from "./VueFriendVerification"
class FriendVerification extends WinBase {
...
class IpcController {
    ...
    public ChangefriendG(msg: IpcI) {
        delete msg.IpcCom;
        // friendVerification.VuePage.consentList.groups = msg;
    }
}
